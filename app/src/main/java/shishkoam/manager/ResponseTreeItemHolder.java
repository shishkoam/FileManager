...
/**
 * Created by ав on 03.01.2016.
 */
public class ResponseTreeItemHolder extends TreeNode.BaseNodeViewHolder<IconTreeItem> {
    ...
    public ResponseTreeItemHolder (Context context) {
        super(context);
    }
    ...
    public View createNodeView(final TreeNode node, IconTreeItem value) {
        ...
        sizeText.setText(" " + ResponseActivity.getNodeSize(node)/1024 + " kb ");
        final int status = ResponseActivity.getCheckBoxValue(node);
        changeCheckbox(status);
        checkBox.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ResponseActivity.setCheckedState(node, checkBox.isChecked());
